package com.woxapp.task.geopath.adapter;
...
public class PlaceArrayAdapter extends ArrayAdapter<PlaceArrayAdapter.PlaceAutocomplete>
    ...
    private static final String LOG_TAG = "PlaceArrayAdapter";
    ...
    public void setGoogleApiClient(GoogleApiClient googleApiClient) {
        if (googleApiClient == null || !googleApiClient.isConnected()) mGoogleApiClient = null;
        else mGoogleApiClient = googleApiClient;
    }
    ...
    private List<PlaceAutocomplete> getPredictions(CharSequence constraint) {
        if (mGoogleApiClient != null) {
            Log.i(LOG_TAG, "Executing autocomplete query for: " + constraint);
            ...
            if (!status.isSuccess()) {
                ...
                Log.e(LOG_TAG, "Error getting place predictions: " + status.toString());
